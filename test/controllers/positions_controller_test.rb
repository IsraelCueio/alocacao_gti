...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post positions_url, params: { position: { description: @position.description, load: @position.load, name: @position.name } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { description: @position.description, load: @position.load, name: @position.name } }
